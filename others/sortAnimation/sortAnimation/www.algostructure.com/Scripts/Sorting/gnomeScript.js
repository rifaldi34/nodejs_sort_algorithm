...
function initFastSort(){
    	...
    	// timer that calls the gnomeSort function every 2 milSec. 
		startTimer = setInterval(function(){gnomeSort();}, milSec);
...
function initSort(){
    if(arr.length > 1){
    	...
    	// timer that calls the gnomeSort function every 300 milSec. 
    	startTimer = setInterval(function(){gnomeSort();}, milSec);
