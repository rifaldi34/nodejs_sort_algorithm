...
var i, n, m; // variables for sorting algorithm
var tempKey;
var sorting = false;	
...
function initFastSort(){
    	...
    	// timer that calls the cocktailSort function every 2 milSec. 
		startTimer = setInterval(function(){cocktailSort();}, milSec);
...
function initSort(){
    if(arr.length > 1){
    	...
    	// timer that calls the cocktailSort function every 300 milSec. 
    	startTimer = setInterval(function(){cocktailSort();}, milSec);
...
// sorts all keys with cocktailSort sort.
