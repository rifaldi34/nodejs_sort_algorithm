...
function initFastSort(){
    	...
    	// timer that calls the oddevenSort function every 2 milSec. 
		startTimer = setInterval(function(){oddevenSort();}, milSec);
...
function initSort(){
    if(arr.length > 1){
    	...
    	// timer that calls the oddevenSort function every 300 milSec. 
    	startTimer = setInterval(function(){oddevenSort();}, milSec);
...
// sorts all keys with oddevenSort.
